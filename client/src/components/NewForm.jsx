  ...
  return (
    <section className="relative w-full overflow-hidden bg-background py-16 md:py-24">
      <div
        ...
        style={{
          background: `radial-gradient(circle at center, #8500f5, transparent 70%)`,
        }}
      />
      <div
              ...
              >
                ...
                >
                  <Button
                    ...
                    className="w-full bg-gradient-to-b from-[#8500f5] to-[#8500f5] text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]"
                  >
                    {isSubmitting ? (
            ...
            >
              <div className="flex flex-col items-center justify-center overflow-hidden">
                <article className="relative mx-auto h-[350px] min-h-60 max-w-[650px] overflow-hidden rounded-3xl bg-gradient-to-b from-[#8500f5] to-[#e60a64]/5 p-6 text-3xl tracking-tight text-white md:h-[450px] md:min-h-80 md:p-8 md:text-4xl md:leading-[1.05] lg:text-5xl">
                  ...
                  <div className="absolute -bottom-20 -right-20 z-10 mx-auto flex h-full w-full max-w-[300px] items-center justify-center transition-all duration-700 hover:scale-105 md:-bottom-34 md:-right-35 md:max-w-[550px]">
                    <Earth
                      scale={1.1}
                      baseColor={[0.521, 0, 0.960]}
                      markerColor={[0, 0, 0]}
                      glowColor={[0.521, 0, 0.960]}
                    />
                  </div>
                </article>
              </div>
